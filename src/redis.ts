 ...
 * ```
 */
export function redisConnect(opts: RedisConnectOptions): { connected: boolean; queueKey: string } {
 ...
 */
export function redisDisconnect(): { disconnected: boolean } {
 ...
 */
export function redisSetQueueKey(queueKey: string): { queueKey: string } {
