...
function handleWhatsAppMessage(message) {
    ...
    if (messageContent) {
        if (messageContent.conversation) {
            ...
            console.log(`🖼️ Image message with caption: ${messageContent.imageMessage.caption || '(no caption)'}`);
        }
        else if (messageContent.videoMessage) {
            console.log(`🎬 Video message with caption: ${messageContent.videoMessage.caption || '(no caption)'}`);
        }
...
function handleChatPresence(message) {
    const event = message.event;
